...
namespace MGPSDK
{
    ...
    public class MGPGameManager : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            sdkConfigJsonString = "{\"data\":{\"accessToken\":\"" + AuthToken + "\",\"lobbyData\":{\"gameModeId\":\"" + gameModeId + "\",\"_id\":\"" + lobyid + "\",\"entryFee\":" + entryFee + ",\"noOfPlayer\":" + noOfPlayer + ",\"minPlayer\":2,\"noOfRounds\":" + nofRound + ",\"winningAmount\":9,\"moneyMode\":\"RealMoney\",\"isUseBot\":" + Isbot.ToString().ToLower() + ",\"IsFTUE\":" + IsFTUE.ToString().ToLower() + "},\"gameData\":{\"assetsPath\":\"/data/user/0/com.threegames/files/636e40187d9acb813b72e411\",\"game\":\"CallBreak\",\"gameID\":\"" + gameId + "\",\"isPlay\":" + isPlay.ToString().ToLower() + "  },\"playerData\":[{\"name\":\"Ketul\",\"userId\":\"636ce30456ca6ca392a8dc6b\",\"profilPic\":\"\"}],\"location\":{\"latitude\":\"" + latitude + "\",\"longitude\":\"" + longitude + "\"},\"socketDetails\":{\"hostURL\":\"" + S3URL + "\",\"portNumber\":\"" + portNo + "\",\"socketTimeOut\":0},\"selfUserDetails\":{\"avatar\":\"https://artoon-game-platform.s3.amazonaws.com/mgp-3games/AvatarImages/avatarImage-1668590057158.png\",\"displayName\":\"" + userName + "\",\"mobileNumber\":\"8320352712\",\"userID\":\"" + __userId + "\"}}}"; Debug.Log(" <color=green>MGPGameManager || Awake || GetIntent || getStringExtra || sdkConfigJsonString :</color>" + sdkConfigJsonString);
